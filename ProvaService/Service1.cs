...
namespace WriteToSql
{
    public partial class Service1 : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            //richiama il metodo per scrivere nel file che il servizio è iniziato all'ora X
            WriteToDB.WriteToDatabase($"Servizio iniziato alle {DateTime.Now}");
        ...
        private void OnElapsedTime(object sender, ElapsedEventArgs e)
        {
            ...
            WriteToDB.WriteToDatabase("Il servizio è stato richiamato alle " + DateTime.Now);
        }
        ...
        protected override void OnStop()
        {
            ...
            WriteToDB.WriteToDatabase("il servizio si è fermato alle: " +  DateTime.Now);
        }
    }
}
